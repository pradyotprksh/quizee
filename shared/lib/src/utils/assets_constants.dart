/// Contains the assets name used in the application.
abstract class AssetsConstants {
  static const String defaultLogo = 'assets/default_logo.png';
  ...
  static const String congratulation = 'assets/congratulation.json';
}
